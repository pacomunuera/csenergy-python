...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Título y subtítulo
%\newcommand{\titulo}{Simulación de un campo solar de concentradores cilindroparabólicos}
%\newcommand{\subtitulo}{Aplicación de un modelo de 4º Orden al cálculo del rendimiento}
%% Datos del autor
%\newcommand{\miNombre}{Francisco José Munuera Pérez}
%\newcommand{\miEmail}{pacomunuera@gmail.com}
%% Datos del tutor/es
%\newcommand{\miTutor}{Rubén Barbero Fresno}
%%\newcommand{\miTutorB}{Nombre Apellido1 Apellido2 (tutor2)}
%\newcommand{\departamentoTutor}{Departamento de Ingeniería Energétical}
%%\newcommand{\departamentoTutorB}{Departamento del cotutor}
%% Datos de la facultada y universidad
%\newcommand{\miFacultad}{E.T.S. de Ingenieros Industriales}
%\newcommand{\miFacultadCorto}{}
%\newcommand{\miUniversidad}{\protect{Universidad Nacional de Educación a Distancia}}
%\newcommand{\miUbicacion}{}
...
\begin{verbatim}
{
 "simulation": 
 {
  ...
  "benchmark": true,
  "fastmode": true,
  "filename": "2007 DATOS SAM VALIDACION.csv",
  "filepath": "C:/Users/paco/0_TFG/csenergy/fielddata_files/",
  "first_date": "2007/01/01 00:00",
  "last_date": "2007/03/31 23:00"
 },
 "model": {
  "name": "Barbero1stOrder",
  "max_err_t": 1.0,
  "max_err_tro": 0.1,
  "max_err_pr": 0.01
 },
 ...
 "HCE": {
  ...
  "Absorber emittance factor A0": 0.101,
  "Absorber emittance factor A1": 0.000131,
 ...
 "HTF": {
  "source": "table",
  "name": "DOWTHERM A",
  "cp": [-2363.4842, 39.461021, -0.17024546, 0.0003903868, -4.421524e-07, 1.9792489e-10, 0, 0, 0],
  "rho": [1492.4628, -3.331716, 0.012479716, -2.9684039e-05, 3.4437643e-08, -1.6215295e-11, 0, 0, 0],
  "kt": [0.18560707,-0.000160008, 5.9133304e-12, 0, 0, 0, 0, 0, 0],
  "h": [-651130.67, 4121.3664,-12.345938, 0.027710651,-2.7764463e-05,1.1056661e-08, 0, 0, 0],
  "t": [285.344, 0.000620726, -1.82158e-10, -1.42322e-16, 3.31588e-22, -1.75256e-28, 0, 0, 0],
  "mu": [1.5829736497643845, -0.023379494161758788, 0.00015039587510591723, -5.489414584985482e-07,
         1.2416726255122127e-09, -1.7808745329776023e-12, 1.5809758771617201e-15, -7.941353131126612e-19,
         1.7280680058112407e-22],
   "tmax": 750.0,
   "tmin": 288.0
 },
 "subfields": [
