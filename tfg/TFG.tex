...
A methodology based on Object Oriented Programming (OOP) is followed and each physical system is modeled through a Class. The main mathematical model used to calculate the performance of the solar concentrator is the 4th Order Model proposed in \cite{barberofresnoDesarrolloModeloTeorico2018}.
