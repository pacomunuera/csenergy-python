...
\label{tab:coeficientes_dowa} \\ \hline
\parbox{3em}{Parámetro} 	& 
\parbox{3em}{$C_p(T)$}		& 
\parbox{3em}{$\mu(T)$}		& 
\parbox{3em}{$\rho(T)$}  	& 
\parbox{3em}{$K_T$}     		&  
\parbox{3em}{h(T)}			& 
\parbox{3em}{T(h)}       \\ \hline
\endfirsthead
\multicolumn{7}{c}%
...
\label{tab:coeficientes_vp1} \\ \hline
\parbox{3em}{\centering Parámetro}	& 
\parbox{2em}{\centering  $C_p(T)$} 	&
\parbox{2em}{\centering  $\mu(T)$}		& 
\parbox{2em}{\centering  $\rho(T)$} 	& 
\parbox{2em}{\centering $K_T$}      	&  
\parbox{2em}{\centering h(T)}			&
\parbox{2em}{\centering T(h)}   		\\ \hline
\endfirsthead
\multicolumn{7}{c}%
{{Tabla \thetable\ continúa desde la página anterior}} \\ \hline
\parbox{3em}{\centering Parámetro}	& 
...
\label{tab:configuracionSCA} \\ \hline
...
\label{tab:configuracionHCE} \\ \hline
Parámetro & Valor \\ \hline
\endfirsthead
\multicolumn{2}{c}%
{{Tabla \thetable\ continúa desde la página anterior}} \\ \hline
...
\label{tab:generacion_anual} \\ \hline
...
\label{tab:datos_17_julio} \\ \hline
Hora &
\parbox{3em}{\centering \rule{0pt}{2ex}  DNI \\ (S, P) ($W/m^2$)} &
\parbox{3em}{\centering \rule{0pt}{2ex}  Caudal (S)  \\  ($kg/s$)}    &
\parbox{3em}{\centering \rule{0pt}{2ex}  Caudal (P)  \\  ($kg/s$)}  &
\parbox{3em}{\centering \rule{0pt}{2ex}  $T_{in}$ \\ (S, P)  \\ $(^\circ C)$} &
\parbox{3em}{\centering \rule{0pt}{2ex}  $T_{out}$ \\ (S)  \\ $(^\circ C)$} &
\parbox{3em}{\centering \rule{0pt}{2ex}  $T_{out}$ \\ (P)  \\ $(^\circ C)$} &
\parbox{4em}{\centering \rule{0pt}{2ex}  Pot. Térmica (S)  \\  (MWt)}  &
\parbox{4em}{\centering \rule{0pt}{2ex}  Pot. Térmica (P) \\  (MWt)} \\ \hline
\endfirsthead
\multicolumn{9}{c}%
{{Tabla \thetable\ continúa desde la página anterior}} \\ \hline
Hora &
...
\label{tab:datos_17_junio} \\ \hline
Hora &
\parbox{3em}{\centering \rule{0pt}{2ex} DNI (S, P) \\ ($W/m^2$)} &
\parbox{3em}{\centering \rule{0pt}{2ex} Caudal (S)  \\  ($kg/s$)}    &
\parbox{3em}{\centering \rule{0pt}{2ex} Caudal (P)  \\  ($kg/s$)}  &
\parbox{3em}{\centering \rule{0pt}{2ex} $T_{in}$  \\ (S, P)  \\ $(^\circ C)$} &
\parbox{2em}{\centering \rule{0pt}{2ex} $T_{out}$ (S)  \\ $(^\circ C)$} &
\parbox{2em}{\centering \rule{0pt}{2ex} $T_{out}$ (P)  \\ $(^\circ C)$} &
\parbox{4em}{\centering \rule{0pt}{2ex} Pot. Térmica (S)  \\  (MWt)}  &
\parbox{4em}{\centering \rule{0pt}{2ex} Pot. Térmica (P) \\  (MWt)} \\ \hline
\endfirsthead
\multicolumn{9}{c}%
