...
Fecha &
  \multicolumn{1}{c}{DNI (S, P)} &
  \multicolumn{1}{c}{Caudal (S)} &
  \multicolumn{1}{c}{Caudal (P)} &
  \multicolumn{1}{c}{$T_{in}$ (S, P)} &
  \multicolumn{1}{c}{$T_{out}$ (S)} &
  \multicolumn{1}{c}{$T_{out}$ (P)} &
  \multicolumn{1}{c}{Pot. Térmica (S)} &
  \multicolumn{1}{c}{Pot. Térmica (P)} \\
   & ($W/m^2$)   & ($Kg/s$)   &  ($Kg/s$)  & $(\circ C)$  & $(\circ C)$  & $(\circ C)$  &  (MWt)  &  (MWt)   \\ 
